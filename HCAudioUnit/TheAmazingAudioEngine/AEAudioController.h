...
@property (nonatomic,assign) BOOL useFileInput;
@property (nonatomic,assign,readonly,getter=getMixerAudioUnit) AudioUnit mMixer;
@property (nonatomic,assign,readonly,getter=getMixerNode) AUNode mixerNode;
