 ...
 */
@interface AEFloatConverterEZ : NSObject
 ...
 */
BOOL AEFloatConverterToFloatEZ(AEFloatConverterEZ* converter, AudioBufferList *sourceBuffer, float * const * targetBuffers, UInt32 frames);
 ...
 * @return YES on success; NO on failure
 */
BOOL AEFloatConverterFromFloatEZ(AEFloatConverterEZ* converter, float * const * sourceBuffers, AudioBufferList *targetBuffer, UInt32 frames);
