...
static OSStatus complexInputDataProcEZ(AudioConverterRef             inAudioConverter,
...
@implementation AEFloatConverterEZ
...
BOOL AEFloatConverterToFloatEZ(AEFloatConverterEZ* THIS, AudioBufferList *sourceBuffer, float * const * targetBuffers, UInt32 frames) {
...
BOOL AEFloatConverterToFloatBufferListEZ(AEFloatConverterEZ* converter, AudioBufferList *sourceBuffer,  AudioBufferList *targetBuffer, UInt32 frames) {
    ...
    return AEFloatConverterToFloatEZ(converter, sourceBuffer, targetBuffers, frames);
}

BOOL AEFloatConverterFromFloatEZ(AEFloatConverterEZ* THIS, float * const * sourceBuffers, AudioBufferList *targetBuffer, UInt32 frames) {
    if ( frames == 0 ) return YES;
...
BOOL AEFloatConverterFromFloatBufferListEZ(AEFloatConverterEZ* converter, AudioBufferList *sourceBuffer, AudioBufferList *targetBuffer, UInt32 frames) {
    ...
    return AEFloatConverterFromFloatEZ(converter, sourceBuffers, targetBuffer, frames);
}
